defmodule TaskTrackerWeb.TaskControllerTest do
  ...
  @create_attrs %{desc: "some desc", done: true, time_spent: 42, title: "some title"}
  @update_attrs %{desc: "some updated desc", done: false, time_spent: 43, title: "some updated title"}
  @invalid_attrs %{desc: nil, done: nil, time_spent: nil, title: nil}
